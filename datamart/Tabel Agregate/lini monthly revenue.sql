...
--- Table Lini Revenue per bulan
CREATE TABLE IF NOT EXISTS lini_monthly_revenue AS
(
	SELECT 
...
ALTER TABLE lini_monthly_revenue ALTER COLUMN bulan type character varying,
ALTER TABLE lini_monthly_revenue ALTER COLUMN jumlah_transaksi type int,
ALTER TABLE lini_monthly_revenue ALTER COLUMN jumlah_produk_terjual type int;