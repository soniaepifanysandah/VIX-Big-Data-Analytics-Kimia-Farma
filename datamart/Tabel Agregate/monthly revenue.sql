...
ALTER TABLE monthly_revenue ALTER COLUMN bulan type character varying,
ALTER TABLE monthly_revenue ALTER COLUMN jumlah_transaksi type int,
ALTER TABLE monthly_revenue ALTER COLUMN jumlah_produk_terjual type int;